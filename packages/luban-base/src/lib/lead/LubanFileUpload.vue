...
withDefaults(
  ...
  { modelValue: '', label: '文件上传', accept: '', required: false, disabled: false, error: false }
);
...
<template>
  <div class="lb-form-field">
    ...
    <input class="lb-input" :class="{ 'lb-input--error': error }" type="file" :accept="accept" :name="name" :disabled="disabled" :aria-invalid="error" @change="onChange" />
