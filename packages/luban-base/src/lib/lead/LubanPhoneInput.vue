...
withDefaults(
  ...
  { modelValue: '', label: '手机号', placeholder: '请输入手机号', required: false, disabled: false, error: false }
);
...
<template>
  <div class="lb-form-field">
    ...
    <input class="lb-input" :class="{ 'lb-input--error': error }" type="tel" inputmode="numeric" :value="modelValue" :name="name" :placeholder="placeholder" :disabled="disabled" :aria-invalid="error" @input="onInput" />
