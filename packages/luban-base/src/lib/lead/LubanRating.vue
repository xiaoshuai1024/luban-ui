...
const props = withDefaults(
  ...
  { modelValue: 0, label: '评分', max: 5, required: false, disabled: false, error: false }
);
...
.lb-rating { display: inline-flex; gap: 4px; }
.lb-rating__star { background: none; border: none; cursor: pointer; font-size: 24px; color: #ddd; padding: 0; }
.lb-rating__star--active { color: #ffa726; }
.lb-rating__star:disabled { cursor: not-allowed; }
</style>
